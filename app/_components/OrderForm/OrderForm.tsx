  ...
  return (
    <div className="w-full max-w-sx sm:w-full lg:max-w-5xl bg-white border border-gray-200 rounded-lg shadow p-6 sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
      <form className="space-y-6" onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className="w-full text-white bg-DarkRoyalBlue hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        >
